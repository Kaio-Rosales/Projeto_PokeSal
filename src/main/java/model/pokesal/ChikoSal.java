...
public class ChikoSal implements PokeSal {
  ...
  private static final List<Ataque> ATAQUES = Arrays.asList(
      ...
      new Ataque("Cabeçada", TipoElemental.NORMAL, 8, 3, 1, StatusEfeito.PARALISADO, 30),
      new Ataque("Folha Mágica", TipoElemental.GRAMA, 15, 3, 5, StatusEfeito.ENVENENADO, 30),
