...
public class Terrenos {
  ...
  /**
   * Desativa todos os terrenos, para que apenas o evento mais recente tenha
   * efeito.
   */
  ...
  /**
   * Multiplicador de dano do golpe: Quente +15% para fogo, Molhado +10% para
   * água.
   */
  ...
  public static void curaFimDeTurno(PokeSal pokeSal) {
    ...
    if (novoHp > pokeSal.getHpAtual()) {
      ...
      System.out.println(pokeSal.getClass().getSimpleName()
          + " recuperou " + cura + " de HP graças ao terreno florido!");
    }
  }
}