...
O sistema deve permitir que o jogador mude o nome do personagem.
...
O jogador pode andar pelos campus da UCSAL.
...
Eventos aleatórios devem acontecer quando se faz um movimento de ida ou de volta.
